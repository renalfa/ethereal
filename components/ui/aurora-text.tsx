...
export function AuroraText({
  ...
  return (
    <MotionComponent
      className={cn("relative inline-flex overflow-hidden font-extrabold", className)}
      {...props}
    >
      {children}
      <span className="absolute inset-0 pointer-events-none mix-blend-lighten dark:mix-blend-darken">
